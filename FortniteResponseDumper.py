...
path = os.path.join(os.path.split(os.path.abspath(__file__))[0], "Dumped files", currentDate)
...
if bDumpAccountCloudstorage == "true":
    ...
    while True:
        ...
        reqGetCloudstorageFileText = session.get(links.cloudstorageRequest.format(f"user/{accountId}/{fileID}"), headers=headers, data="").content
