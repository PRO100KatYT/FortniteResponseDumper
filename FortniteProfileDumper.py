...
print("Fortnite Profile Dumper v1.0.0 by PRO100KatYT\n")
...
reqGetAthenaProfile = requests.post(links.getProfile.format(account_id, "athena"), headers=headers, data="{}")
...
reqGetCampaignProfile = requests.post(links.getProfile.format(account_id, "campaign"), headers=headers, data="{}")
...
reqGetCollectionBookPeopleProfile = requests.post(links.getProfile.format(account_id, "collection_book_people0"), headers=headers, data="{}")
...
reqGetCollectionBookSchematicsProfile = requests.post(links.getProfile.format(account_id, "collection_book_schematics0"), headers=headers, data="{}")
...
reqGetCollectionsProfile = requests.post(links.getProfile.format(account_id, "collections"), headers=headers, data="{}")
...
reqGetCommonCoreProfile = requests.post(links.getProfile.format(account_id, "common_core"), headers=headers, data="{}")
...
reqGetCommonPublicProfile = requests.post(links.getProfile.format(account_id, "common_public"), headers=headers, data="{}")
...
reqGetCreativeProfile = requests.post(links.getProfile.format(account_id, "creative"), headers=headers, data="{}")
...
reqGetMetadataProfile = requests.post(links.getProfile.format(account_id, "metadata"), headers=headers, data="{}")
...
reqGetOutpostProfile = requests.post(links.getProfile.format(account_id, "outpost0"), headers=headers, data="{}")
...
reqGetTheaterProfile = requests.post(links.getProfile.format(account_id, "theater0"), headers=headers, data="{}")
